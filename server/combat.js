    ...
    weapons: {
        ...
        swords: [
            ...
            },
            {
                ...
                bonusLong: '<p>Attacks with the Zweihander also counts against 2 adjacent targets, dealing an unmodified (no Str, Skills, Descriptions) 3d3! damage on hit instead.</p><br><p>The Zweihander gives a +10 to Knock-backs (including adjacent targets effected by the pervious ability).</p>'
            },
        ],
        trauma: [
            {
