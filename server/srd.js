const express = require('express')
    ...
    , flawAndIBCtrl = require('./flawAndIBController')
    , path = require('path')
...
app.get('/getRandomIB', flawAndIBCtrl.getRandomIB)
app.get('/getRandomIB/:number', flawAndIBCtrl.getMultipleRandomIB)
app.get('/getRandomDevotion', ctrl.getRandomDevotion)
app.get('/getIBTables', flawAndIBCtrl.getIBTables)
app.get('/getNewParentTable/:roll', flawAndIBCtrl.getNewParentTable)
app.get('/getNewIB/:parentTable', flawAndIBCtrl.getNewIB)
