...
export class ChapterSixAdvancedComponent implements OnInit {
  ...
  chapterName = '';
  side =[{linkid: 'h', body: 'STRESS', jump: '6heEYhImWZRu'}, {linkid: 'hg', body: 'STRESS PENALTIES', jump: '6pxXlsMGLnB'}, {linkid: 'hg', body: 'HEALING STRESS', jump: 'healingstrejiosss'}, {linkid: 'hg', body: 'MENTAL BREAKDOWNS', jump: '8cvTzNxbyhv'}, {linkid: 'h', body: 'VITALITY', jump: '6hscFsXKKFIO'}, {linkid: 'hg', body: 'DROPPING A VITALITY CATEGORY & ENCUMBRANCE', jump: '6TgtqEMxhsi'}, {linkid: 'hg', body: 'TAKING A BREATHER', jump: 'takeabreatherfjiojioxsa'}, {linkid: 'hg', body: 'HEALING', jump: '6hgsDsSgINrBx'}, {linkid: 'h', body: 'HONOR', jump: '6hPwGysmEcvV'}, {linkid: 'hg', body: 'BONUS CrP', jump: '6hgNCVSVWFXeu'}, {linkid: 'hg', body: 'STARTING HONOR', jump: '6hgbvTTNJDlHZ'}, {linkid: 'hg', body: 'HONOR CATEGORIES & BONUSES', jump: '6hgDyUyoZBWAw'}, {linkid: 'hg', body: 'GAINING & LOSING HONOR', jump: '6hgmskMjEXzPU'}, {linkid: 'h', body: 'FAME', jump: '6khdVfMTjDX'}, {linkid: 'hg', body: 'GAINING & LOSING FAME', jump: '6hgoGqxwxcBtQ'}, {linkid: 'hg', body: 'FAME & HONOR', jump: '6hgkLmpnpLtOJ'}, {linkid: 'hg', body: 'ATTRACTING NPCS', jump: '6bgprJtyLnW'}]
