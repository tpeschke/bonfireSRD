...
const routes: Routes = [
  ...
  {path: 'chapter/12', loadChildren: './chapters/chapter-twelve/chapter-twelve.module#ChapterTwelveModule' },
  {path: 'chapter/13', loadChildren: './chapters/chapter-thirteen/chapter-thirteen.module#ChapterThirteenModule' },
  {path: 'chapter/11', loadChildren: './chapters/chapter-eleven/chapter-eleven.module#ChapterElevenModule' },
  {path: 'chapter/8', loadChildren: './chapters/chapter-eight/chapter-eight.module#ChapterEightModule' },
  {path: 'chapter/5', loadChildren: './chapters/chapter-five/chapter-five.module#ChapterFiveModule' },
  {path: 'chapter/7', loadChildren: './chapters/chapter-seven/chapter-seven.module#ChapterSevenModule' },
  ...
  {path: 'chapter/10', loadChildren: './chapters/chapter-ten/chapter-ten.module#ChapterTenModule' },
  ...
  {path: 'chapter/9', loadChildren: './chapters/chapter-nine/chapter-nine.module#ChapterNineModule' },
  {path: 'chapter/14', loadChildren: './chapters/chapter-fourteen/chapter-fourteen.module#ChapterFourteenModule' },
