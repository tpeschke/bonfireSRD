...
const routes: Routes = [
  ...
  {path: 'character-creation/7', loadChildren: './character-creation/chapter-seven/cc-seven.module#CcSevenModule' },
  {path: 'character-creation/6', loadChildren: './character-creation/chapter-six/cc-six.module#CcSixModule' },
  {path: 'character-creation/5', loadChildren: './character-creation/chapter-five/cc-five.module#CcFiveModule' },
  {path: 'character-creation/4', loadChildren: './character-creation/chapter-four/cc-four.module#CcFourModule' },
  {path: 'character-creation/3', loadChildren: './character-creation/chapter-three/cc-three.module#CcThreeModule' },
  {path: 'character-creation/2', loadChildren: './character-creation/chapter-two/cc-two.module#CcTwoModule' },
  {path: 'character-creation/1', loadChildren: './character-creation/chapter-one/cc-one.module#CcOneModule' },
