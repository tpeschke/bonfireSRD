export default {
    tables: {
        ...
        'rangedBasic': [{ name: 'Composite Bow', size: 'M', price: 45 }, { name: 'Crossbow', size: 'L', price: 75 }, { name: 'Javelin', size: 'M', price: 8 }, { name: 'Latchet Crossbow', size: 'L', price: 30 }, { name: 'Longbow', size: 'L', price: 60 }, { name: 'Sling', size: 'S', price: 5 }, { name: 'Throwing Axe', size: 'S', price: 12 }, { name: 'Throwing Knife', size: 'S', price: 10 }]
    },
    multipliers: {
        local: {
            T: 1.10,
