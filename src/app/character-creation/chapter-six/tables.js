export default {
    tables: {
        ...
        'ranged': [{ name: 'Bellybow', size: 'L', price: 175 }, { name: 'Composite Bow', size: 'M', price: 45 }, { name: 'Crossbow', size: 'L', price: 75 }, { name: 'Fire Lance', size: 'L', price: 105 }, { name: 'Hakenbuchse', size: 'L', price: 235 }, { name: 'Handgonne', size: 'M', price: 110 }, { name: 'Javelin', size: 'M', price: 8 }, { name: 'Latchet Crossbow', size: 'L', price: 50 }, { name: 'Longbow', size: 'L', price: 60 }, { name: 'Sling', size: 'S', price: 5 }, { name: 'Throwing Axe', size: 'S', price: 12 }, { name: 'Throwing Knife', size: 'S', price: 10 }, { name: 'Warbow', size: 'L', price: 255 },],
        'rangedBasic': [{ name: 'Composite Bow', size: 'M', price: 45 }, { name: 'Crossbow', size: 'L', price: 75 }, { name: 'Javelin', size: 'M', price: 8 }, { name: 'Latchet Crossbow', size: 'L', price: 50 }, { name: 'Longbow', size: 'L', price: 60 }, { name: 'Sling', size: 'S', price: 5 }, { name: 'Throwing Axe', size: 'S', price: 12 }, { name: 'Throwing Knife', size: 'S', price: 10 }],
