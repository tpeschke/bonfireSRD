export default {
    tables: {
        ...
        'adventuring': [{ name: "Alm Script, /Favor", size: 'S', price: 24 }, { name: 'Blanket, Travel, Cotton', size: 'S', price: 4.5 }, { name: 'Chalk, 4, Box of 20"', size: 'S', price: 0.05 }, { name: 'Fire Starter (flint Rock and Steel Rod)', size: 'S', price: 0.6 }, { name: 'Grapnel Hook, Steel, Four Hooks', size: 'S', price: 16 }, { name: 'Rations, Person, Day', size: 'S', price: 2.5 }, { name: 'Lantern, Tin, Yellow Glass, Pt. Tank', size: 'S', price: 7 }, { name: 'Lock, Standard Metal, with key', size: 'S', price: 100 }, { name: 'Lock Picks, Steel, Set of Six', size: 'S', price: 12 }, { name: 'Pry Bar, Steel, 15", Pry Head and Claw Head', size: 'M', price: 12 }, { name: 'Sharpening Stone, 3"', size: 'S', price: 0.8 }, { name: 'Spike, Iron, 12"', size: 'S', price: 1.25 }, { name: 'Spyglass, With Wooden Tubes', size: 'S', price: 20 }, { name: 'Stake, Anti-Vampire, Wooden, 8"', size: 'S', price: 0.2 }, { name: 'Tent, 1 Person', size: 'M', price: 5 }, { name: 'Tent, 2 Person', size: 'L', price: 12 }, { name: 'Tent, 4 Person', size: 'L', price: 25 }, { name: 'Torch', size: 'S', price: 0.4 },],
