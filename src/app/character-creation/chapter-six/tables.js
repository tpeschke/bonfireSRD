export default {
    tables: {
        ...
        'polearms': [{ name: 'Ahlspiess', size: 'L', price: 17 }, { name: 'Bill', size: 'L', price: 17 }, { name: 'Glaive', size: 'L', price: 35 }, { name: 'Guisarme', size: 'L', price: 22 }, { name: 'Halberd', size: 'L', price: 42 }, { name: 'Lance', size: 'L', price: 45 }, { name: 'Lucerne', size: 'L', price: 37 }, { name: 'Military Fork', size: 'L', price: 19 }, { name: 'Planson', size: 'M', price: 10 }, { name: 'Pike', size: 'H', price: 20 }, { name: 'Ranseur', size: 'L', price: 33 }, { name: 'Short Spear', size: 'M', price: 16 }, { name: 'Sovnya', size: 'L', price: 32 }, { name: 'Voulge', size: 'L', price: 27 }, { name: 'War-scythe', size: 'L', price: 16 },],
