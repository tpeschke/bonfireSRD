export default {
    tables: {
        ...
        'armor': [
            { name: 'Banded Mail', complex: 4, size: 'M', price: 335 },
            { name: 'Brigandine', complex: 5, size: 'M', price: 650 },
            ...
            { name: 'Coat of Plates', complex: 4, size: 'M', price: 190 },
            { name: 'Gambeson', complex: 3, size: 'S', price: 90 },
            { name: 'Lamellar', complex: 5, size: 'M', price: 370 },
            { name: 'Leather', complex: 3, size: 'S', price: 190 },
            { name: 'Full Plate', complex: 6, size: 'L', price: 2125 },
            { name: 'Plated Mail', complex: 6, size: 'L', price: 1140 },
            { name: 'Ringmail', complex: 4, size: 'M', price: 350 },
            { name: 'Scale', complex: 6, size: 'L', price: 1075 },
            { name: 'Splintmail', complex: 4, size: 'M', price: 275 },
