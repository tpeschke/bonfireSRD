export default {
    tables: {
        ...
        'sidearms': [{ name: 'Brass Knuckles', size: 'S', price: 10 }, { name: 'Cinquedea', size: 'S', price: 15 }, { name: 'Dagger', size: 'S', price: 12 }, { name: 'Knife', size: 'S', price: 10 }, { name: 'Stiletto', size: 'S', price: 17 }, { name: 'Dusack', size: 'S', price: 49 }, { name: 'Katzbalger', size: 'S', price: 55 }, { name: 'Scourge', size: 'M', price: 10 },],
        ...
        'trauma': [{ name: 'Bec De Corbin', size: 'L', price: 75 }, { name: 'Bludgeon', size: 'S', price: 8 }, { name: 'Club', size: 'M', price: 5 }, { name: 'Mace', size: 'M', price: 48 }, { name: 'Maul', size: 'L', price: 35 }, { name: 'Goedendag', size: 'L', price: 24 }, { name: 'Great Hammer', size: 'H', price: 200 }, { name: 'Peasant\'s Flail', size: 'L', price: 20 }, { name: 'Quarterstaff', size: 'L', price: 8 }, { name: 'War Flail', size: 'M', price: 50 }, { name: 'War Hammer', size: 'M', price: 83 },],
        ...
        'polearms': [{ name: 'Ahlspiess', size: 'L', price: 17 }, { name: 'Bill', size: 'L', price: 17 }, { name: 'Glaive', size: 'L', price: 35 }, { name: 'Guisarme', size: 'L', price: 22 }, { name: 'Halberd', size: 'L', price: 42 }, { name: 'Lance', size: 'L', price: 45 }, { name: 'Lucerne', size: 'L', price: 37 }, { name: 'Military Fork', size: 'L', price: 19 }, { name: 'Short Spear', size: 'M', price: 10 }, { name: 'Pike', size: 'H', price: 20 }, { name: 'Ranseur', size: 'L', price: 33 }, { name: 'Short Spear', size: 'M', price: 16 }, { name: 'Sovnya', size: 'L', price: 32 }, { name: 'Voulge', size: 'L', price: 27 }, { name: 'War-scythe', size: 'L', price: 16 },],
